...
## 2026-08-22 - 루프 내 문자열 보간 최적화
**Learning:** 디렉토리 항목을 생성하는 핫 루프에서 Kotlin의 문자열 보간(`"""...${...}..."""`)을 사용하면 중간 문자열 객체가 불필요하게 할당되어 GC 부하와 실행 시간이 증가합니다.
**Action:** 핫 루프 내에서 문자열을 조합할 때는 중간 객체 할당을 방지하기 위해 `StringBuilder.append()` 체이닝을 직접 사용해야 합니다.
