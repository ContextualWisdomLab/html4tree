...
## 2024-05-24 - Redundant Directory Listings in Kotlin
**Learning:** Calling `curr_dir.list()` multiple times across different conditional blocks causes redundant and expensive OS I/O operations.
**Action:** Cache directory listings in a local variable hoisted at the top of the function (above conditional execution paths) to genuinely reuse the evaluation across the entire function scope.
