...
## 2026-08-24 - Remove incorrect ARIA role="status" from static element
...
**Action:** Ensure ARIA live region roles are only applied to elements whose content updates dynamically after the initial page load, to provide accurate feedback to screen reader users without unnecessary disruptions.
