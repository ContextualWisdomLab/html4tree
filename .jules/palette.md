...
## 2026-08-21 - 빈 디렉토리 메시지의 ARIA role 속성 제거
**Learning:** 초기 로드 시 렌더링되는 정적 요소에 `role="status"`와 같은 ARIA live region을 적용하면 스크린 리더가 중복해서 읽거나 페이지 읽기 흐름을 방해할 수 있습니다.
**Action:** 정적인 안내 메시지에는 불필요한 ARIA live region 속성을 추가하지 않고 시맨틱 HTML과 적절한 텍스트로 대체합니다.
