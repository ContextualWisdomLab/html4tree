...
**Learning:** span:last-child와 같은 구조적 CSS 선택자를 사용하면, 나중에 접근성을 위해 추가된 시각적으로 숨겨진(.visually-hidden) 요소에 의도치 않은 스타일이 적용될 수 있습니다.
**Action:** 대화형 텍스트 등에 호버/포커스 스타일을 적용할 때는 구조적 선택자 대신 명시적인 클래스(.entry-name 등)를 부여하여 대상을 한정해야 합니다.
