...
## 2024-10-24 - [UX improvement] BiDi text support
**Learning:** 디렉토리 및 파일 이름(예: 오른쪽에서 왼쪽으로 쓰는 문자)을 올바르게 렌더링하기 위해 텍스트가 포함된 `<h1>` 및 `<span>` 요소에 `dir="auto"` 속성을 추가해야 합니다.
**Action:** 텍스트를 포함하는 요소에 `dir="auto"`를 추가하여 다양한 언어의 파일명을 올바르게 렌더링할 수 있도록 지원합니다.
