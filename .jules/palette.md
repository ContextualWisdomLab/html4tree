...
## 2024-09-08 - 빈 디렉토리 아이콘 메타포
**학습:** 디렉토리 목록에서 빈 폴더와 내용이 있는 폴더를 시각적으로 구분하지 않으면, 사용자는 빈 폴더를 클릭하여 확인해야 하는 불필요한 상호작용을 겪게 됩니다.
**조치:** 디렉토리 아이콘 렌더링 시 디렉토리가 비어 있는지 확인하고, 비어 있는 경우 열린 폴더 아이콘(`&#128194;`)을 사용하여 사용자에게 시각적 힌트를 제공하여 불필요한 클릭을 방지하십시오.
