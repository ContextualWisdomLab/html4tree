...
## 2024-05-24 - Restore visual hover feedback
**Learning:** Structural CSS pseudo-classes like `:last-child` easily break when accessibility elements like `.visually-hidden` are added to the end of a container, breaking visual styles like hover underlines.
