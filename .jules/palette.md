...
## 2024-05-18 - ARIA Live Region on Static Content
...
**Action:** Remove `role="status"` from static empty state messages generated on server-side/initial render. Only use live regions for dynamic content updates that occur without a page reload.
