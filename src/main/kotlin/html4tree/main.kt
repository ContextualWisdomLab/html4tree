...
fun process_ignore_file(curr_dir: File, dirFilesNames: Array<String>? = null): Set<String> {
    ...
    cachedDirList?.forEach {
        // ⚡ Bolt Performance Optimization: Defer expensive string allocations (toLowerCase)
        // Check cheap short-circuiting properties like isHiddenFile() and endsWith() first.
