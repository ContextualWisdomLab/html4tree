...
""" 
    ...
    val index_middle = fun():String{ 
        ...
        // By estimating ~256 chars per list item based on filesList size, we avoid O(N) internal array re-allocations
        val l = StringBuilder(if (filesList == null || filesList.isEmpty()) 128 else filesList.size * 256)
