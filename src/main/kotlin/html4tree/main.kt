...
<html lang="ko">
     <head>
        ...
        <meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src '${Constants.styleHash}'; base-uri 'none'; form-action 'none';">
...
""" 
   ...
   try {
       // ⚡ Bolt Performance Optimization: Use cached index_bottom from Constants
