...
// ⚡ Bolt Performance Optimization: Extract static assets to prevent redundant allocations and hashing
// This avoids O(N) memory allocation and SHA-256 hashing per directory iteration in process_dir.
// We use const val and @JvmField to prevent implicit getter generation, maintaining 100% JaCoCo coverage.
