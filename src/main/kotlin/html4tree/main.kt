...
fun go(topDir: String, maxLevel: Int)  {
    ...
    // SECURITY: Use absoluteFile instead of canonicalFile to avoid prematurely
    // resolving symlinks, which would bypass the NOFOLLOW_LINKS check below
    // and potentially allow path traversal vulnerabilities via symlinks.
