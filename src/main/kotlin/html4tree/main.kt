...
fun process_ignore_file(curr_dir: File, dirFilesNames: Array<String>? = null): Set<String> {
    ...
    (dirFilesNames ?: curr_dir.list())?.forEach {
        // ⚡ Bolt Performance Optimization: Defer expensive string allocation (toLowerCase) until after cheap short-circuit checks
        // Prevents unnecessary GC pressure for hidden files or backup files.
