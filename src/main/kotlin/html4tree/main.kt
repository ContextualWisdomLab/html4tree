...
fun process_ignore_file(curr_dir: File, dirFilesNames: Array<String>? = null): Set<String> {
    ...
    // ⚡ Bolt Performance Optimization: Cache directory listing at the top of the function
    // to prevent redundant and expensive OS I/O calls across different blocks.
