...
fun process_ignore_file(curr_dir: File, dirFilesNames: Array<String>? = null): Set<String> {
    ...
    (dirFilesNames ?: curr_dir.list())?.forEach {
        // ⚡ Bolt Performance Optimization: Defer expensive toLowerCase() string allocation
        // until after cheap short-circuiting checks (isHiddenFile, endsWith) are evaluated.
