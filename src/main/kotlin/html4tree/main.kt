...
// ⚡ Bolt Performance Optimization: Extract static strings and expensive cryptographic hashing to top-level
// to avoid re-evaluating them per-directory during recursive filesystem traversal.
val cssContent = """
              body {
