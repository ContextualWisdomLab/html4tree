...
// 1. Pre-computes SHA-256 hash at class-loading instead of per-directory
// 2. Avoids large string allocations inside recursive directory processing
// 3. Uses const val / @JvmField to prevent implicit getters and maintain 100% JaCoCo coverage
