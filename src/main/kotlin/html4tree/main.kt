...
// ⚡ Bolt Performance Optimization: Move static CSS and expensive SHA-256 hash computation
// to top-level properties to compute them exactly once, rather than per directory.
val cssContent = """
              body {
