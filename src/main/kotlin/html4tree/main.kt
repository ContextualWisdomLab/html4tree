...
// ⚡ Bolt Performance Optimization: Hoisted static CSS strings and expensive SHA-256 computation
// to top-level `private val`s to prevent redundant allocations and processing overhead per directory.
