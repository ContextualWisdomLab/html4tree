...
class MainTest {
    ...
    fun testProcessDir() {
        ...
        assertTrue(htmlContent.contains("<span class=\"visually-hidden\">file1.txt 파일</span>"))
        assertTrue(htmlContent.contains("title=\"file1.txt 파일\""))
        assertTrue(htmlContent.contains("<span class=\"visually-hidden\">subdir 디렉토리</span>"))
