...
class MainTest {
    ...
    fun testProcessDir() {
        ...
        assertRobotsDirective(htmlContent)
        assertTrue(htmlContent.contains("<h2 id=\"dir-list-label\" class=\"visually-hidden\">디렉토리 목록</h2>"))
        assertTrue(htmlContent.contains("<nav aria-labelledby=\"dir-list-label\">"))
        assertTrue(htmlContent.contains("role=\"list\""))
